...
enum CountTrainWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: CountTrainWebStatus) -> Bool {
        switch (self, other) {
...
extension CountTrainWebStatus {
    static func == (lhs: CountTrainWebStatus, rhs: CountTrainWebStatus) -> Bool {
