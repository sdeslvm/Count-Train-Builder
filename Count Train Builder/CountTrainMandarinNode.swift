...
final class CountTrainOrientationManager {
    static let shared = CountTrainOrientationManager()
...
final class CountTrainAppDelegate: NSObject, UIApplicationDelegate {
    func application(
