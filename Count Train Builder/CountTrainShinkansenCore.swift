...
final class CountTrainBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: CountTrainWebLoader
    private let coordinator: CountTrainWebCoordinator
    ...
    init(
        ...
        loader: CountTrainWebLoader,
        coordinator: CountTrainWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        CountTrainOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        CountTrainOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        CountTrainOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension CountTrainBaseWebViewController {
