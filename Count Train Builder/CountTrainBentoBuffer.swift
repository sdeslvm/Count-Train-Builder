...
class CountTrainWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (CountTrainWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (CountTrainWebStatus) -> Void) {
